...
public final class Benchmarking_multiply_jmhTest {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            if (Benchmarking_jmhType.setupIterationMutexUpdater.compareAndSet(l_benchmarking0_G, 0, 1)) {
                try {
                    ...
                    Benchmarking_jmhType.setupIterationMutexUpdater.set(l_benchmarking0_G, 0);
                }
            } else {
                while (Benchmarking_jmhType.setupIterationMutexUpdater.get(l_benchmarking0_G) == 1) {
                    if (control.isFailing) throw new FailureAssistException();
            ...
            if (Benchmarking_jmhType.tearIterationMutexUpdater.compareAndSet(l_benchmarking0_G, 0, 1)) {
                try {
                    ...
                    Benchmarking_jmhType.tearIterationMutexUpdater.set(l_benchmarking0_G, 0);
                }
            } else {
                while (Benchmarking_jmhType.tearIterationMutexUpdater.get(l_benchmarking0_G) == 1) {
                    if (control.isFailing) throw new FailureAssistException();
                    if (Thread.interrupted()) throw new InterruptedException();
                }
            }
            ...
            if (control.isLastIteration()) {
                if (Benchmarking_jmhType.tearTrialMutexUpdater.compareAndSet(l_benchmarking0_G, 0, 1)) {
                    try {
                        if (control.isFailing) throw new FailureAssistException();
                        ...
                        Benchmarking_jmhType.tearTrialMutexUpdater.set(l_benchmarking0_G, 0);
                    }
                } else {
                    long l_benchmarking0_G_backoff = 1;
                    while (Benchmarking_jmhType.tearTrialMutexUpdater.get(l_benchmarking0_G) == 1) {
                        TimeUnit.MILLISECONDS.sleep(l_benchmarking0_G_backoff);
                        l_benchmarking0_G_backoff = Math.max(1024, l_benchmarking0_G_backoff * 2);
                        if (control.isFailing) throw new FailureAssistException();
                        if (Thread.interrupted()) throw new InterruptedException();
                    }
                }
    ...
    public BenchmarkTaskResult multiply_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        this.benchmarkParams = control.benchmarkParams;
        this.iterationParams = control.iterationParams;
        this.threadParams    = threadParams;
        this.notifyControl   = control.notifyControl;
    ...
    public BenchmarkTaskResult multiply_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        this.benchmarkParams = control.benchmarkParams;
        this.iterationParams = control.iterationParams;
        this.threadParams    = threadParams;
        this.notifyControl   = control.notifyControl;
    ...
    public BenchmarkTaskResult multiply_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        this.benchmarkParams = control.benchmarkParams;
        this.iterationParams = control.iterationParams;
        this.threadParams    = threadParams;
        this.notifyControl   = control.notifyControl;
    ...
    Benchmarking_jmhType _jmh_tryInit_f_benchmarking0_G(InfraControl control) throws Throwable {
        ...
        synchronized(this.getClass()) {
            try {
            if (control.isFailing) throw new FailureAssistException();
            val = f_benchmarking0_G;
            if (val != null) {
                return val;
            }
            val = new Benchmarking_jmhType();
            Field f;
            f = project.Benchmarking.class.getDeclaredField("n");
